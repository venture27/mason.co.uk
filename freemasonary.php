...
require_once('includes/head.php');
			?>
			<div class="hover-box" id="main-feed">
				<h1>WHAT IS FREEMASONARY?</h1>
				<h3>LOREM IPSUMATION BLAH BLAH</h3>
				<div class="scratch" style="width:935px;margin-bottom:38px;"></div>
				...
				Morbi mi. Quisque nisl felis, venenatis tristique, dignissim in, ultrices sit amet, augue. Proin sodales libero eget ante. Nulla quam. Aenean laoreet. Vestibulum nisi lectus, commodo ac, facilisis ac, ultricies eu, pede. Ut orci risus, accumsan porttitor, cursus quis, aliquet eget, justo. 
				Sed pretium blandit orci. Ut eu diam at pede suscipit sodales. Aenean lectus elit, fermentum non, convallis id, sagittis at, neque. Nullam mauris orci, aliquet et, iaculis et, viverra vitae, ligula. Nulla ut felis in purus aliquam imperdiet. Maecenas aliquet mollis lectus. 
				</p>
			</div>
